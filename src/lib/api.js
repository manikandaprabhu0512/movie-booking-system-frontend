...
export const moviesApi = {
  create: (payload) =>
    api.post("/movies/add-movie", payload).then((r) => r.data),
...
export const showSeatsApi = {
  ...
  updateStatus: (id, status) =>
    api
      .put(`/show-seats/${id}/status`, null, { params: { status } })
      .then((r) => r.data),
...
export const bookingsApi = {
  create: (payload) =>
    api.post("/bookings/create", payload).then((r) => r.data),
  ...
  updatePaymentStatus: (id, paymentStatus) =>
    api
      .put(`/bookings/${id}/payment-status`, null, {
  ...
  checkIdempotency: (key) =>
    api
      .get(`/bookings/check-idempotency`, { params: { idempotencyKey: key } })
      .then((r) => r.data),
};

export const paymentsApi = {
  create: (payload) =>
    api.post("/payments/create", payload).then((r) => r.data),
